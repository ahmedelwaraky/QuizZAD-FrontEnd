...
export function ClassQuiz() {
  ...
  const fetchData = async () => {
    try {
      ...
      const imageName = response.data.classQuizzes.map(
        (image) =>
        ...
        <div className="container p-0">
          <div className="row mb-2">
            <div className="col-md-11 text-center m-auto bg-light px-3 rounded-4 mt-2">
              <h3 className="py-2">Explore Class Quizzes</h3>
          ...
          <div className="quizlist">
            <div className="container">
              <div className="row row-cols-1 row-cols-md-2 row-cols-xl-3 ">
                {myClass.classQuizzes &&
                  myClass.classQuizzes.map((card) => (
                    <div className="col-mb-4 p-2" key={card.id}>
                      <div className="bg-light border p-4 rounded-5">
                        ...
                        { myUser?.role == 'ADMIN' && <div className="d-flex justify-content-center">
                          <NavLink
                        ...
                        {myUser?.role != 'ADMIN' && 
                              <div className="d-flex">
                              <NavLink className="p-2 rounded-5 quizButton fs-5 text-center" to={`/dashboard/quiz/${card.id}`}>View Quiz</NavLink>
                            </div>}
                      </div>
                    </div>
                  ))}
